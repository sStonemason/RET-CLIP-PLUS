...
from RET_CLIP.eval.data import _preprocess_text
...
def parse_args():
    ...
    parser.add_argument("--output", type=str,
                        default="/home/ubuntu/nfs/8T1/dujw/clip/downstream_train_valid_test/few_shot/fives_ret-clip_test.json",
...
def main():
    ...
    text_features = build_text_features(model, text_classes, context_length=150, device=device)
