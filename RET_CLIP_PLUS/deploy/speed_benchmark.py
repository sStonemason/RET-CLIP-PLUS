...
import RET_CLIP_v3.clip as clip
from RET_CLIP_v3.clip.utils import create_model, _MODEL_INFO, image_transform
from RET_CLIP_v3.training.main import convert_models_to_fp32, convert_weights
from RET_CLIP_v3.deploy.benchmark_utils import track_infer_time, print_timings
...
if __name__ == '__main__':
    ...
    if args.tensorrt_image_model and args.device == "cuda":
        from cn_clip_v3.deploy.tensorrt_utils import TensorRTModel
