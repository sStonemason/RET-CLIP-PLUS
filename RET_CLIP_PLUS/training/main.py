...
from RET_CLIP_PLUS.clip import load
from RET_CLIP_PLUS.clip.model import convert_weights, convert_state_dict, resize_pos_embed, CLIP
from RET_CLIP_PLUS.training.train import train, evaluate
from RET_CLIP_PLUS.training.data import get_data
from RET_CLIP_PLUS.training.params import parse_args
from RET_CLIP_PLUS.training.logger import setup_primary_logging, setup_worker_logging
from RET_CLIP_PLUS.training.scheduler import cosine_lr
from RET_CLIP_PLUS.training.pcgrad_amp import PCGradAMP
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        if args.should_save and num_steps_this_epoch > 0:
            if (epoch + 1) == args.max_epochs or (
                ...
                # )
                torch.save(
                    model.state_dict() if not args.use_flash_attention else convert_state_dict(model.state_dict()),
                    save_path, )
                logging.info(
