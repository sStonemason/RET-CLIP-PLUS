...
def get_default_params(model_name):
    ...
    elif model_name in ["ViT-B-32", "ViT-B-16", "ViT-H-14", "ViT-S-8"]:
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        # required=True,
        default="/home/ubuntu/nfs/8T2/dujw/datasets/tongren_v3_512_2input/lmdb2/train",
        help="Path to the LMDB directory with training data split",
    )
    parser.add_argument(
        "--val-data",
        type=str,
        default="/home/ubuntu/nfs/8T2/dujw/datasets/tongren_v3_512_2input/lmdb2/valid",
    ...
    parser.add_argument(
        "--valid-num-workers", type=int, default=1,
        help="The number of workers for validation dataloader (if making validation)."
    )
    parser.add_argument(
        "--logs",
        type=str,
        default="/home/ubuntu/nfs/8T2/dujw/experiments/",
    ...
    parser.add_argument(
        "--report-training-batch-acc", default=True, action="store_true",
        help="Whether to report training batch accuracy."
    )
    parser.add_argument(
        "--batch-size", type=int, default=8, help="Batch size for training per GPU."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--valid-step-interval", type=int, default=999999,
    ...
    parser.add_argument("--lr", type=float, default=3e-5, help="Learning rate.")  # 2023.10.10
    parser.add_argument("--beta1", type=float, default=None, help="Adam beta 1.")  # 2023.10.10
    parser.add_argument("--beta2", type=float, default=None, help="Adam beta 2.")  # 2023.10.10
    parser.add_argument("--eps", type=float, default=None, help="Adam epsilon.")  # 2023.10.10
    ...
    parser.add_argument(
        "--resume_visual",
        default="/home/ubuntu/nfs/8T1/dujw/clip/datapath_clip/pretrained_weights/clip_cn_rn50.pt",
        type=str,
        help="path to latest checkpoint of vision encoder (default: none)",
    )
    # 2023.10.17
    parser.add_argument(
        "--resume_text",
        default="/home/ubuntu/nfs/8T1/dujw/clip/datapath_clip/pretrained_weights/clip_cn_vit-b-16.pt",
        type=str,
        help="path to latest checkpoint of text encoder (default: none)",
    )
    parser.add_argument(
        "--reset-optimizer",
        action="store_true",
    ...
    parser.add_argument(
        "--vision-model",
        choices=["ViT-B-32", "ViT-B-16", "ViT-L-14", "ViT-L-14-336", "ViT-H-14", "RN50", "ViT-S-8"],
        default="RN50",
